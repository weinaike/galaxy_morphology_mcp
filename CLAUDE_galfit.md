...
| n (Sérsic) | Disk: none (expdisk, n ≡ 1 by type). Bulge: fixed 4 at depth ≤ 2, free within 0.5–8 at depth ≥ 3. Bar: fixed 0.5, never released. Lens: free, prior < 0.5 — **n ≥ 0.6 hard** (not a lens profile; 0.5–0.6 note). OuterDisk (sersic variant): free, **< 1 hard**. Single Sersic: free (overall-concentration observable) |
