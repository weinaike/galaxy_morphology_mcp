...
Output **2–3** candidates. Typical directions: fix constraints, release/tighten a parameter, add a compact point-source component (an AGN, `psf` — only under the Bulge-Re-collapse admission rule), switch a component's model type.
