        ...
        3. 多成分分解流程
            ...
            - 伴星系认定与添加条件
                - 伴星系按距主星系中心的远近分为两类，均需认真识别：
                    ...
                    - **（B）嵌入式伴星系（Embedded Companion）**：紧贴主星系中心亮区，落在主星系 bulge/bar/disk 的等照度线 contour **之上或以内**，距中心仅约 1–3·Re_bar（典型 0.3–0.8·Re_disk，几角秒到十几角秒）。这类伴星系对中心成分拟合有强烈污染作用（会让 bulge n 坍缩、bar 出现假性四极矩残差、disk Re 异常膨胀），**必须优先识别和拟合**。
                - 两类伴星系的共同特征：
