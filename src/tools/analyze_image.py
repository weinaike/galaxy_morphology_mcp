...
def galfit_analyze_by_vllm(
    ...
    prompt = f"""Analyze the following single-band GALFIT optimization results.
...
Please provide a detailed, structured analysis with specific observations and actionable recommendations."""
    ...
    # System message
    system_message = "You are an expert in astronomical image analysis and galaxy morphology. You specialize in evaluating single-band GALFIT optimization results and providing detailed, scientifically rigorous assessments."
...
def galfits_analyze_by_vllm(
    ...
    # Create the prompt for the multimodal model
    prompt = f"""Analyze the following multi-band GALFIT (GalfitS) optimization results.
...
highlighting the advantages and challenges of multi-band fitting."""
    ...
    # System message
    system_message = "You are an expert in astronomical image analysis, galaxy morphology, and multi-wavelength observations. You specialize in evaluating multi-band GALFIT (GalfitS) optimization results with SED modeling, providing detailed, scientifically rigorous assessments that consider cross-band consistency and spectral energy distributions."
