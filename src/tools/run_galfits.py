...
def TEST_create_perband_comparison_png():
    ...
    pngs = create_perband_comparison_png(lyric_file, gssummary_file, result_fits_file_list)
    print("Generated comparison PNGs:", pngs)

def TEST_create_multiband_comparison_png():
    lyric_file = "/home/jiangbo/obj_list/28/output/20260519_115017_obj_28/obj_28.lyric"
    gssummary_file = "/home/jiangbo/obj_list/28/output/20260519_115017_obj_28/obj28.gssummary"
    result_fits_file_list = glob("/home/jiangbo/obj_list/28/output/20260519_115017_obj_28/*_result.fits")

    pngs = create_multiband_comparison_png(lyric_file, gssummary_file, result_fits_file_list)
    print("Generated comparison PNGs:", pngs)

if __name__ == '__main__':
    config_file = "/home/jiangbo/obj_list/1042/obj_1042.lyric"    
    image_fitting_workplace = "/home/jiangbo/obj_list/1042/output"
    import asyncio
    res = asyncio.run(run_galfits_image_fitting(config_file=config_file, extra_args=["--fit_method", "ES"]))
    print(res)
